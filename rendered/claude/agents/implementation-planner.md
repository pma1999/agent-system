...
description: "Use when the orchestrator needs the design and dispatch-ready plan bundle for a new feature, non-trivial change, or raw idea. Consumes context maps and integration recipes, writes plans/<slug>/ with design, constraints, task briefs, and progress, and never writes production code."
model: opus
effort: xhigh
color: blue
