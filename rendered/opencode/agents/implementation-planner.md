...
## Agent Boundary
Execute this brief directly. Do not load `opencode-orchestrator` or spawn work owners; the parent
...
```markdown
# Progress: <feature>
Planning: engine=opencode | model=opencode-go/muse-spark-1.3-contributor | effort=xhigh
