---
description: "Use when the orquestador needs a current external contract not already proven in the repo: a third-party API, SDK, library, CLI, or scraping target. Verifies the needed surface, writes an Integration Recipe, and never writes production code."
mode: subagent
