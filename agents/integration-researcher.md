...
The recipe may feed a Claude-authored or explicitly user-requested Codex-authored plan bundle. Keep it planner-engine-neutral: verified integration facts and risks only, with no planner model/effort settings and no implementation-engine routing.
